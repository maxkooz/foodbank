...
class Task(models.Model):
    ...
    associated_food_bank = models.ForeignKey(FoodBank, on_delete=models.CASCADE)
...
class Vehicle(models.Model):
    driver_volunteer = models.ForeignKey(Volunteer, on_delete=models.CASCADE)
...
class DistributedFoodItem(models.Model):
    ...
    recipient_org = models.ForeignKey('RecipientOrganization', on_delete=models.CASCADE)
